...
import com.example.crudwithvaadin.Puisi;
import com.example.crudwithvaadin.PuisiEditor;
import com.example.crudwithvaadin.PuisiPrinter;
import com.example.crudwithvaadin.PuisiRepository;
...
public class UserView extends VerticalLayout {
    ...
    private final PuisiPrinter editor;
...
//	final TextArea puisi;
    ...
    public UserView(PuisiRepository repo, PuisiPrinter editor) {
        this.repo = repo;
        this.editor = editor;
...
//		puisi.setValue(isi);
        ...
        // build layout
        HorizontalLayout actions = new HorizontalLayout(filter,btnExit);
